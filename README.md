...
`gemini-google-search-tool` is a Python CLI tool built with modern tooling and best practices.
...
make run ARGS="..."   # Run gemini-google-search-tool locally
...
```
gemini-google-search-tool/
├── gemini_google_search_tool/    # Main package
│   ├── __init__.py
